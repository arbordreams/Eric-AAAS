...
def estimate_vllm_max_batch_tokens(h100_80gb: bool = True) -> int:
    """Return a conservative max_batch_tokens for vLLM on 80GB H100."""
    return 65536 if h100_80gb else 32768
